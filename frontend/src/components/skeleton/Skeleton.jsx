...
const Skeleton = (props) => {
  return (
    <ContentLoader viewBox="0 0 446 160" height={160} width={446} {...props}>
      ...
      <rect x="39" y="12" rx="5" ry="5" width="150" height="10" />
      <rect x="40" y="29" rx="5" ry="5" width="150" height="10" />
      ...
      <rect x="45" y="104" rx="5" ry="5" width="150" height="10" />
      <rect x="45" y="122" rx="5" ry="5" width="150" height="10" />
    </ContentLoader>
  );
};
